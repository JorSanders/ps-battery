...
pub fn parse_battery_and_charging(args: &ParseBatteryAndChargingArgs) -> (u8, bool) {
    let battery_offset: usize = if args.connection_type == ConnectionType::Bluetooth {
    ...
    let is_charging = if args.connection_type == ConnectionType::Bluetooth {
    ...
    println!(
        "battery_byte=0b{:08b}, battery_level_nibble=0b{:04b}, battery_state_nibble=0b{:04b}, battery_percent={}, is_fully_charged={}",
        battery_byte, battery_level_nibble, battery_state_nibble, battery_percent, is_fully_charged
    );
    println!(
        "charging_byte=0b{:08b}, is_charging={}",
